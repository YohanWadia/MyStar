...
define('zapp_user_main', ['dart_sdk', 'flutter_sdk'], (function load__zapp_user_main(dart_sdk, flutter_sdk) {
  ...
  var _currentImage = dart.privateName(main, "_currentImage");
  ...
  main._MyHomePageState = class _MyHomePageState extends framework.State$(main.MyHomePage) {
    build(context) {
      return new scaffold.Scaffold.new({appBar: new app_bar.AppBar.new({title: new text.Text.new(this.widget.title)}), body: new basic.Center.new({child: new basic.Column.new({mainAxisAlignment: flex.MainAxisAlignment.spaceAround, children: T.JSArrayOfWidget().of([new image.Image.asset(this[_currentImage], {width: 200, height: 200, fit: box_fit.BoxFit.cover}), new elevated_button.ElevatedButton.new({onPressed: dart.fn(() => {
                  this[_currentImage] = "assets/images/two.PNG";
  ...
  (main._MyHomePageState.new = function() {
    this[_currentImage] = "assets/images/placeholder.png";
  ...
  dart.setFieldSignature(main._MyHomePageState, () => ({
    ...
    [_currentImage]: dart.fieldType(core.String)
  }));
  ...
  }, '{"version":3,"sourceRoot":"","sources":["/zapp/project/.zapp_entry.dart","/zapp/project/lib/main.dart","/zapp/project/.dart_tool/dartpad/web_plugin_registrant.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;AA2CI,IA1BF,iCAAgB;AACd,UAAoB,6BAGD;AAF8B,QAA9B,AAAkB,6BAElB,eAF2B;;AAEL,QAAF,CAApB;;AAEnB,UAAO,AAAQ,uBAAY;AAKvB,QAJK,AAAqC,qBAA7B,qCAAuB,uBAAW,QAAC;AAG9C,UAFC,AAAQ,sBAAW,2BAA2B,CAC/C;;;wBAIL,SAAC,GAAG;AACL,UAAO,AAAQ,uBAAY;AAIvB,QAHC,AAAQ,sBAAW,wBAAwB,CAC5C,AAAE,CAAD,eACD,AAAW,UAAD;;2DAGM,yCACb,SAAC,MAAM,QAAQ,MAAM;AAC1B,cAAO,AAAQ,uBAAY;AAC4B,YAAlD,AAAQ,sBAAW,wBAAwB,CAAC,IAAI;;;EAI3D;;AAEiB;AAQd,MAPD,MAAS,gCACC;AACS,UAAf;6CAEe;AACmB,UAAjB;;IAGvB;;;;;;;;;UC7C4B;AACxB,YAAO,iCACE,wBACA,2CACmB,oCACV,kBACS,kCAEd,2CACe,kCACV,kBACS,uEAGG;IAEhC;;;QAnBmB;AAAb,8CAAa,GAAG;;EAAE;;;;;;;;;;IAyBX;;;;;;;;;;;;AAGsB;IAAkB;;;QAL7B;QAAmB;;AAArC,mDAAkB,GAAG;;EAAuB;;;;;;;;;;;;;;;;;;;;;;;;;;;;;UAcxB;AACxB,YAAO,oCACG,+BACC,kBAAK,AAAO,4BAEf,6BACG,yCACgC,8CACnB,wBAEV,sBACJ,6BACO,aACC,UACI,wBAMd,mDACa;AAE8B,kBAAvC,sBAAgB;AAGA,kBAAhB,cAAS;;;IAWvB;;;;;;IAzCO,sBAAgB;;;EA0CzB;;;;;;;;;;;;;AA/EuB,IAArB;EACF;;ECGwB","file":"main.js"}');
  // Exports:
  return {
