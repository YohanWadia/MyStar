...
define('zapp_user_main', ['dart_sdk', 'flutter_sdk'], (function load__zapp_user_main(dart_sdk, flutter_sdk) {
  ...
  dart.defineLazy(CT, {
    ...
    get C1() {
      return C[1] = dart.const({
        ...
        [Widget_key]: null,
        [MyHomePage_title]: "Lamp and Booleans"
      });
    },
    get C2() {
  ...
  main.MyApp = class MyApp extends framework.StatelessWidget {
    ...
    build(context) {
      return new app.MaterialApp.new({title: "Flutter App!!", home: C[1] || CT.C1, debugShowCheckedModeBanner: false});
    }
  };
  ...
  main._MyHomePageState = class _MyHomePageState extends framework.State$(main.MyHomePage) {
    build(context) {
      return new scaffold.Scaffold.new({backgroundColor: this.bgColor, appBar: new app_bar.AppBar.new({title: new text.Text.new(this.widget.title)}), body: new basic.Center.new({child: new basic.Column.new({mainAxisAlignment: flex.MainAxisAlignment.center, children: T.JSArrayOfWidget().of([new icon.Icon.new(icons.Icons.lightbulb, {size: 300, color: this.myColor}), new elevated_button.ElevatedButton.new({child: new text.Text.new("ON"), onPressed: dart.fn(() => {
                  this.putOnEffect();
                  this.setState(dart.fn(() => {
                  }, T.VoidTovoid()));
                }, T.VoidTovoid())}), new elevated_button.ElevatedButton.new({child: new text.Text.new("OFF"), onPressed: dart.fn(() => {
                  this.putOffEffect();
                  this.setState(dart.fn(() => {
                  }, T.VoidTovoid()));
                }, T.VoidTovoid())}), new elevated_button.ElevatedButton.new({child: new text.Text.new("ON/OFF"), onPressed: dart.fn(() => {
                  this.setState(dart.fn(() => {
                  }, T.VoidTovoid()));
                }, T.VoidTovoid())})])})})});
    }
    putOnEffect() {
      this.myColor = colors.Colors.yellow;
      this.bgColor = colors.Colors.white70;
    }
    putOffEffect() {
      this.myColor = colors.Colors.black;
      this.bgColor = colors.Colors.grey;
    }
  ...
  dart.setMethodSignature(main._MyHomePageState, () => ({
    ...
    build: dart.fnType(framework.Widget, [framework.BuildContext]),
    putOnEffect: dart.fnType(dart.void, []),
    putOffEffect: dart.fnType(dart.void, [])
  }));
  ...
  dart.setFieldSignature(main._MyHomePageState, () => ({
    ...
    myColor: dart.fieldType(ui.Color),
    bgColor: dart.fieldType(ui.Color)
  }));
  ...
  }, '{"version":3,"sourceRoot":"","sources":["/zapp/project/.zapp_entry.dart","/zapp/project/lib/main.dart","/zapp/project/.dart_tool/dartpad/web_plugin_registrant.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;AA2CI,IA1BF,iCAAgB;AACd,UAAoB,6BAGD;AAF8B,QAA9B,AAAkB,6BAElB,eAF2B;;AAEL,QAAF,CAApB;;AAEnB,UAAO,AAAQ,uBAAY;AAKvB,QAJK,AAAqC,qBAA7B,qCAAuB,uBAAW,QAAC;AAG9C,UAFC,AAAQ,sBAAW,2BAA2B,CAC/C;;;wBAIL,SAAC,GAAG;AACL,UAAO,AAAQ,uBAAY;AAIvB,QAHC,AAAQ,sBAAW,wBAAwB,CAC5C,AAAE,CAAD,eACD,AAAW,UAAD;;2DAGM,yCACb,SAAC,MAAM,QAAQ,MAAM;AAC1B,cAAO,AAAQ,uBAAY;AAC4B,YAAlD,AAAQ,sBAAW,wBAAwB,CAAC,IAAI;;;EAI3D;;AAEiB;AAQd,MAPD,MAAS,gCACC;AACS,UAAf;6CAEe;AACmB,UAAjB;;IAGvB;;;;;;;;;UC7C4B;AACxB,YAAO,iCACE,kEAEqB;IAEhC;;;QATmB;AAAb,8CAAa,GAAG;;EAAE;;;;;;;;;;IAeX;;;;;;;;;;;;AAGsB;IAAkB;;;QAL7B;QAAmB;;AAArC,mDAAkB,GAAG;;EAAuB;;;;;;;;;;;;;UAaxB;AACxB,YAAO,6CACY,sBACT,+BACC,kBAAK,AAAO,4BAEf,6BACG,yCACgC,yCAC3B,wBACR,kBAAW,8BAAgB,YAAW,gBAGtC,+CACM,kBAAK,kBACD;AAEK,kBAAb;AAEc,kBAAd,cAAS;;sCAKX,+CACM,kBAAK,mBACD;AAEM,kBAAd;AAEc,kBAAd,cAAS;;sCAKX,+CACM,kBAAK,sBACD;AAIM,kBAAd,cAAS;;;IAUrB;;AAGyB,MAAvB,eAAiB;AACO,MAAxB,eAAiB;IACnB;;AAGwB,MAAtB,eAAiB;AACI,MAArB,eAAiB;IACnB;;;;;;IAjEM,eAAiB;IACjB,eAAiB;;;EAkEzB;;;;;;;;;;;;;;;;AA7FuB,IAArB;EACF;;ECGwB","file":"main.js"}');
  // Exports:
  return {
