...
// Version: 2.19.2 (stable) (Tue Feb 7 18:37:17 2023 +0000) on "macos_arm64"
...
define('zapp_user_main', ['dart_sdk', 'flutter_sdk'], (function load__zapp_user_main(dart_sdk, flutter_sdk) {
  ...
  main._MyHomePageState = class _MyHomePageState extends framework.State$(main.MyHomePage) {
    build(context) {
      return new scaffold.Scaffold.new({appBar: new app_bar.AppBar.new({title: new text.Text.new(this.widget.title)}), body: new basic.Center.new({child: new basic.Column.new({mainAxisAlignment: flex.MainAxisAlignment.spaceAround, children: T.JSArrayOfWidget().of([new text.Text.new(this.imgtoShow, {style: new text_style.TextStyle.new({fontSize: 60.0})}), new image.Image.asset("assets/" + this.imgtoShow + ".png", {width: 250.0, height: 250.0, fit: box_fit.BoxFit.fill}), new slider.Slider.new({value: this.moodValue, min: 0.0, max: 4.0, divisions: 4, onChanged: dart.fn(value => {
                  this.setState(dart.fn(() => {
                    this.moodValue = value;
                    if (this.moodValue === 0) {
                    }
                    core.print(this.moodValue);
                  }, T.VoidTovoid()));
                }, T.doubleTovoid())})])})})});
    }
  ...
  dart.setFieldSignature(main._MyHomePageState, () => ({
    ...
    moodValue: dart.fieldType(core.double),
    imgtoShow: dart.fieldType(core.String)
  }));
  ...
  }, '{"version":3,"sourceRoot":"","sources":["../.zapp_entry.dart","../lib/main.dart","../.dart_tool/dartpad/web_plugin_registrant.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;AA2CI,IA1BF,iCAAgB;AACd,UAAoB,6BAGD;AAF8B,QAA9B,AAAkB,6BAElB,eAF2B;;AAEL,QAAF,CAApB;;AAEnB,UAAO,AAAQ,uBAAY;AAKvB,QAJK,AAAqC,qBAA7B,qCAAuB,uBAAW,QAAC;AAG9C,UAFC,AAAQ,sBAAW,2BAA2B,CAC/C;;;wBAIL,SAAC,GAAG;AACL,UAAO,AAAQ,uBAAY;AAIvB,QAHC,AAAQ,sBAAW,wBAAwB,CAC5C,AAAE,CAAD,eACD,AAAW,UAAD;;2DAGM,yCACb,SAAC,MAAM,QAAQ,MAAM;AAC1B,cAAO,AAAQ,uBAAY;AAC4B,YAAlD,AAAQ,sBAAW,wBAAwB,CAAC,IAAI;;;EAI3D;;AAEiB;AAQd,MAPD,MAAS,gCACC;AACS,UAAf;6CAEe;AACmB,UAAjB;;IAGvB;;;;;;;;;UC5C4B;AACxB,YAAO,iCACE,wBACA,2CACmB,oCACV,kBACS,kCAEd,2CACe,kCACV,kBACS,uEAGG;IAEhC;;;QApBmB;AAAb,8CAAa,GAAG;;EAAE;;;;;;;;;;IA0BX;;;;;;;;;;;;AAGsB;IAAkB;;;QAL7B;QAAmB;;AAArC,mDAAkB,GAAG;;EAAuB;;;;;;;;;;;;;UAaxB;AAExB,YAAO,oCACG,+BACD,kBAAK,AAAO,4BAEb,6BACG,yCACgC,8CACnB,wBAEhB,kBAAK,wBAAkB,wCAAoB,UAEvC,sBAAM,AAAuB,YAAd,iBAAS,gBACrB,eACC,YACI,uBAIZ,8BACS,qBACF,UACA,gBACM,cACA,QAAQ;AAUf,kBATF,cAAS;AACU,oBAAjB,iBAAY,KAAK;AACjB,wBAAG,AAAS,mBAAE;;AAME,oBAAhB,WAAM;;;IAatB;;;;;;IAnDO,iBAAU;IACV,iBAAY;;;EAmDrB;;;;;;;;;;;;;;AAzFuB,IAArB;EACF;;ECGwB","file":"main.dart.js"}');
  // Exports:
  return {
    var__folders__tc__hwmzxvg53tjd3hyj5wskczcw0000gn__T__compiler$46zapp$46runQmfPN2__project__$46zapp_entry: $46zapp_entry,
    var__folders__tc__hwmzxvg53tjd3hyj5wskczcw0000gn__T__compiler$46zapp$46runQmfPN2__project__lib__main: main,
    var__folders__tc__hwmzxvg53tjd3hyj5wskczcw0000gn__T__compiler$46zapp$46runQmfPN2__project__$46dart_tool__dartpad__web_plugin_registrant: web_plugin_registrant
  };
}));
