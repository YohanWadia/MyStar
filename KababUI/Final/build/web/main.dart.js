...
define('zapp_user_main', ['dart_sdk', 'flutter_sdk'], (function load__zapp_user_main(dart_sdk, flutter_sdk) {
  ...
  dart.defineLazy(CT, {
    ...
    get C9() {
      return C[9] = dart.const({
        __proto__: main.ScaleTransitionExample.prototype,
        [Widget_key]: null
      });
    },
    get C1() {
    ...
    get C11() {
      return C[11] = dart.const({
        __proto__: main.ScaleTransitionExampleApp.prototype,
        [Widget_key]: null
      });
    }
  }, false);
  ...
  main.ScaleTransitionExampleApp = class ScaleTransitionExampleApp extends framework.StatelessWidget {
    static ['_#new#tearOff'](opts) {
      let key = opts && 'key' in opts ? opts.key : null;
      return new main.ScaleTransitionExampleApp.new({key: key});
    }
    build(context) {
      return C[1] || CT.C1;
    }
  };
  (main.ScaleTransitionExampleApp.new = function(opts) {
    let key = opts && 'key' in opts ? opts.key : null;
    main.ScaleTransitionExampleApp.__proto__.new.call(this, {key: key});
    ;
  }).prototype = main.ScaleTransitionExampleApp.prototype;
  dart.addTypeTests(main.ScaleTransitionExampleApp);
  dart.addTypeCaches(main.ScaleTransitionExampleApp);
  dart.setMethodSignature(main.ScaleTransitionExampleApp, () => ({
    __proto__: dart.getMethods(main.ScaleTransitionExampleApp.__proto__),
    build: dart.fnType(framework.Widget, [framework.BuildContext])
  }));
  dart.setLibraryUri(main.ScaleTransitionExampleApp, I[0]);
  main.ScaleTransitionExample = class ScaleTransitionExample extends framework.StatefulWidget {
    static ['_#new#tearOff'](opts) {
      let key = opts && 'key' in opts ? opts.key : null;
      return new main.ScaleTransitionExample.new({key: key});
    }
    createState() {
      return new main._ScaleTransitionExampleState.new();
    }
  };
  (main.ScaleTransitionExample.new = function(opts) {
    let key = opts && 'key' in opts ? opts.key : null;
    main.ScaleTransitionExample.__proto__.new.call(this, {key: key});
    ;
  }).prototype = main.ScaleTransitionExample.prototype;
  dart.addTypeTests(main.ScaleTransitionExample);
  dart.addTypeCaches(main.ScaleTransitionExample);
  dart.setMethodSignature(main.ScaleTransitionExample, () => ({
    __proto__: dart.getMethods(main.ScaleTransitionExample.__proto__),
    createState: dart.fnType(framework.State$(main.ScaleTransitionExample), [])
  }));
  dart.setLibraryUri(main.ScaleTransitionExample, I[0]);
  var ___ScaleTransitionExampleState__controller = dart.privateName(main, "_#_ScaleTransitionExampleState#_controller");
  var ___ScaleTransitionExampleState__animation = dart.privateName(main, "_#_ScaleTransitionExampleState#_animation");
  var _controller = dart.privateName(main, "_controller");
  var _animation = dart.privateName(main, "_animation");
  const State_TickerProviderStateMixin$36 = class State_TickerProviderStateMixin extends framework.State$(main.ScaleTransitionExample) {};
  (State_TickerProviderStateMixin$36.new = function() {
    ticker_provider.TickerProviderStateMixin$(main.ScaleTransitionExample)[dart.mixinNew].call(this);
    State_TickerProviderStateMixin$36.__proto__.new.call(this);
  }).prototype = State_TickerProviderStateMixin$36.prototype;
  dart.applyMixin(State_TickerProviderStateMixin$36, ticker_provider.TickerProviderStateMixin$(main.ScaleTransitionExample));
  main._ScaleTransitionExampleState = class _ScaleTransitionExampleState extends State_TickerProviderStateMixin$36 {
    get [_controller]() {
      let t1, t0;
      t0 = this[___ScaleTransitionExampleState__controller];
      return t0 == null ? (t1 = new animation_controller.AnimationController.new({duration: C[10] || CT.C10, vsync: this}), this[___ScaleTransitionExampleState__controller] == null ? this[___ScaleTransitionExampleState__controller] = t1 : dart.throw(new _internal.LateError.fieldADI("_controller"))) : t0;
    }
    get [_animation]() {
      let t1, t0;
      t0 = this[___ScaleTransitionExampleState__animation];
      return t0 == null ? (t1 = new animations.CurvedAnimation.new({parent: this[_controller], curve: curves.Curves.bounceOut}), this[___ScaleTransitionExampleState__animation] == null ? this[___ScaleTransitionExampleState__animation] = t1 : dart.throw(new _internal.LateError.fieldADI("_animation"))) : t0;
    }
    initState() {
      super.initState();
    ...
    build(context) {
      return new scaffold.Scaffold.new({body: new basic.Center.new({child: new basic.Column.new({children: T.JSArrayOfWidget().of([new transitions.ScaleTransition.new({scale: this[_animation], child: new basic.Padding.new({padding: new edge_insets.EdgeInsets.all(8), child: new basic.SizedBox.new({width: 150, height: 50, child: new image.Image.asset("assets/images/logo.jpg")})})})])})})});
    }
    static ['_#new#tearOff']() {
      return new main._ScaleTransitionExampleState.new();
    }
  };
  (main._ScaleTransitionExampleState.new = function() {
    this[___ScaleTransitionExampleState__controller] = null;
    this[___ScaleTransitionExampleState__animation] = null;
    main._ScaleTransitionExampleState.__proto__.new.call(this);
    ;
  }).prototype = main._ScaleTransitionExampleState.prototype;
  dart.addTypeTests(main._ScaleTransitionExampleState);
  dart.addTypeCaches(main._ScaleTransitionExampleState);
  dart.setMethodSignature(main._ScaleTransitionExampleState, () => ({
    __proto__: dart.getMethods(main._ScaleTransitionExampleState.__proto__),
    build: dart.fnType(framework.Widget, [framework.BuildContext])
  }));
  dart.setGetterSignature(main._ScaleTransitionExampleState, () => ({
    __proto__: dart.getGetters(main._ScaleTransitionExampleState.__proto__),
    [_controller]: animation_controller.AnimationController,
    [_animation]: animation.Animation$(core.double)
  }));
  dart.setLibraryUri(main._ScaleTransitionExampleState, I[0]);
  dart.setFieldSignature(main._ScaleTransitionExampleState, () => ({
    __proto__: dart.getFields(main._ScaleTransitionExampleState.__proto__),
    [___ScaleTransitionExampleState__controller]: dart.fieldType(dart.nullable(animation_controller.AnimationController)),
    [___ScaleTransitionExampleState__animation]: dart.fieldType(dart.nullable(animation.Animation$(core.double)))
  }));
  ...
  }, '{"version":3,"sourceRoot":"","sources":["/zapp/project/.zapp_entry.dart","/zapp/project/lib/main.dart","/zapp/project/.dart_tool/dartpad/web_plugin_registrant.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;AA2CI,IA1BF,iCAAgB;AACd,UAAoB,6BAGD;AAF8B,QAA9B,AAAkB,6BAElB,eAF2B;;AAEL,QAAF,CAApB;;AAEnB,UAAO,AAAQ,uBAAY;AAKvB,QAJK,AAAqC,qBAA7B,qCAAuB,uBAAW,QAAC;AAG9C,UAFC,AAAQ,sBAAW,2BAA2B,CAC/C;;;wBAIL,SAAC,GAAG;AACL,UAAO,AAAQ,uBAAY;AAIvB,QAHC,AAAQ,sBAAW,wBAAwB,CAC5C,AAAE,CAAD,eACD,AAAW,UAAD;;2DAGM,yCACb,SAAC,MAAM,QAAQ,MAAM;AAC1B,cAAO,AAAQ,uBAAY;AAC4B,YAAlD,AAAQ,sBAAW,wBAAwB,CAAC,IAAI;;;EAI3D;;AAEiB;AAQd,MAPD,MAAS,gCACC;AACS,UAAf;6CAEe;AACmB,UAAjB;;IAGvB;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;UC/C4B;AACxB;IACF;;;QALuC;AAAjC,kEAAiC,GAAG;;EAAE;;;;;;;;;;;;;;AAYG;IAA8B;;;QAHzC;AAA9B,+DAA8B,GAAG;;EAAE;;;;;;;;;;;;;;;;;;;;;AAQV;gCAAc,oFAEpC,uKAFsB;IAG9B;;;AAC4B;gCAAa,4CAChC,0BACM,wLAFa;IAG5B;;AAIkB,MAAX;AACe,MAArB,AAAY;IACd;;AAIuB,MAArB,AAAY;AACG,MAAT;IACR;UAG0B;AACxB,YAAO,kCACC,6BACG,gCACK,wBACR,4CACS,yBACC,gCACc,+BAAI,WACjB,+BACE,aACC,WACK,sBAAM;IAQnC;;;;;;uDA1C+B;sDAIF;;;EAuC/B;;;;;;;;;;;;;;;;;;;AA/De;EAAyC;;ECKhC","file":"main.js"}');
  // Exports:
  return {
